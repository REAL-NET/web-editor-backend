...
{
  public class ConstraintsCheckSystem
  {
    private List<Constraint> constraints;

    private IModel repoModel;
    private ConstraintsMatcher matcher;

    public ConstraintsCheckSystem(IModel targetModel)
    {
      this.constraints = new List<Constraint>();
      this.repoModel = targetModel;
      this.matcher = new ConstraintsMatcher(repoModel);
    }
    ...
    {
      var result = true;
      foreach (var node in this.repoModel.Nodes) 
      {
